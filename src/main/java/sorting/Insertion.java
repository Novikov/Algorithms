...
public class Insertion {
    public static void main(String[] args) {
        ...
        /**
         * 1.Найти минимальный элемент массива и поставить его на первое место.
         * 2.Переключиться на следующий индекс, найти минимальный элемент подмассива и поставить его на первое место.
         * */
